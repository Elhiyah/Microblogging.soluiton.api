...
namespace Microblogging.Migrations
{
    ...
    [Migration("20241107094613_RenameUsersToAppUsers")]
            ...
            modelBuilder.Entity("Microblogging.Models.User", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AppUsers__3214EC0719610809");

                    b.HasIndex(new[] { "Email" }, "UQ__AppUsers__A9D10534449B1C77")
                        .IsUnique()
                        .HasFilter("[Email] IS NOT NULL");

                    b.HasIndex(new[] { "UserName" }, "UQ__AppUsers__C9F2845611D43C9C")
                        .IsUnique();
